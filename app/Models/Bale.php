...
{
    protected $fillable = ['number','threshold','grade_id','weight_at_reception','weight_at_loading','weight_at_off_loading','weight_at_processing','farmer_id','balereception_id','lorry_id','state','tdrf_number','creation_date','loading_date','off_loading_date','destination_store_id'];
