...
use App\Laratables\StocksLaratables;
use App\Loading;
...
class StocksController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->back()->with('success','Aded to stocks successfully');
    }
    ...
    public function show(Bale $bale)
    {
        ...
        $orders = Order::all();
        $stocks = Stock::all();
        return view('stocks.stocks-info', compact('bales','orders','grades','stocks'));
    }
    ...
    {
        if (request()->ajax()) {
            return Laratables::recordsOf(Stock::class, StocksLaratables::class);
        }
        $bales = Stock::all();

        return view('stocks.index', compact('bales'));
    }


    public function stockin(){
        $bales = Bale::all();
        return view('stocks.stocksin', compact('bales'));
